(function installRequestOverrideShared(root) {
  ...
  function normalizeLog(value) {
    ...
    return {
      ...
      responseCaptured: raw.responseCaptured === true,
      responseBody: raw.responseCaptured === true && byteLength(raw.responseBody || "") <= LIMITS.maxBodyBytes ? String(raw.responseBody || "") : "",
      responseContentType: safeString(raw.responseContentType, LIMITS.maxContentTypeLength),
      responseBodyTruncated: raw.responseBodyTruncated === true,
